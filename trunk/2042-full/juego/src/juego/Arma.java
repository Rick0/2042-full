...
public abstract class Arma extends ObjetoUbicable {
	...
	public void actuar() {
		...
		if (origenAlgo42 ){
			...
			while ( i.hasNext() ) {
				try {
					...
					System.out.println("Algo pas� pero no sabemos bien porque");
				}					
			} 
		} else {
		...
		if ( this.usada ) {
			...
			try {
				...
				System.out.println("El Juego ha sufrido una f�lla irrecuperable");
			}
		}
	}
	...
	public boolean origenAlgo42() {
		/*true indica que quien lanz� el arma fue una instancia de Algo42,
		false en caso contrario.
		*/
